        ...
        <div className={styles.wrapper} >
            ...
            <div className={styles.box} >
                    ...
                    <ul className={styles.DCard} >
                        {
                            departments.map((data, key) => {
                                return <li key={key} ><span>{data}</span><span className={styles.icon} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                ...
                <div className={styles.view} style={{ display: "none" }}>
                    <div className={styles.head}><span className={styles.icon} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
